...
<ul id="members-dir-list" class="member-item-list" role="main">
  ...
  <li>
    ...
    <div class="item">
      <div class="item-title"> <a href="<?php bp_member_permalink(); ?>">
        ...
        <?php /* <?php if ( bp_get_member_latest_update() ) : ?>
        <span class="update">
        <?php bp_member_latest_update(); ?>
        </span>
        <?php endif; ?> */ ?>
       <br />
     <a href="/members/?s=<?php echo bp_member_profile_data( 'field=Country' ); ?>"><?php  bp_member_profile_data( 'field=Country' ); ?></a>

      <br />
   
      </div>
     <?php /* <div class="item-meta"><span class="activity">
