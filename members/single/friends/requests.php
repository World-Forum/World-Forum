	...
	<ul id="friend-list" class="friend-item-list">
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id() ?>">
				...
				<div class="action">
					<a class="friend-deladd-button" href="<?php bp_friend_accept_request_link() ?>"><?php _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
					<a class="friend-deladd-button" href="<?php bp_friend_reject_request_link() ?>"><?php _e( 'Reject', 'buddypress' ); ?></a>
