...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p><?php _e( 'Your avatar will be used on your profile and throughout the site. We recommend your photo is atleast 150px by 150px, Please click "Crop Image" to save your photo', 'buddypress') ?></p>
	...
	<form action="" method="post" id="avatar-upload-form" enctype="multipart/form-data">
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<input type="submit" class="button" name="avatar-crop-submit" id="avatar-crop-submit" value="Crop and Save Image" />
