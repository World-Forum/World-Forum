...
if ( !function_exists( 'world_forum_theme_setup' ) ) {

	function world_forum_theme_setup() {
		...
		*/
		function wff_theme_styles() {
			...
			// keep styles out of the dashboard
			if ( !is_admin() ) {
				wp_enqueue_style( 'the_css', get_template_directory_uri() . '/css/main.min.css' );
				wp_enqueue_style( 'the_sass', get_template_directory_uri() . '/sass/main.min.css' );
		...
		*/
		function world_forum_register_sidebars() {
		...
		add_action( 'widgets_init', 'world_forum_register_sidebars' );


		/**
		* Add_Theme_Support
		* - Here we add any addtional theme support lines
		*/
...
function themeslug_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control( $wp_customize,	'themeslug_logo',
		array(
