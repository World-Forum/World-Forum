		...
		<div class="top-float-bar">
			<div class="search-bar">
				<?php  if ( is_user_logged_in() ) { ?>
					<div class="logout"><a class="logout" href="/account-settings/" >Account Settings</a></div>
					<div class="logout"><a class="logout" href="<?php echo wp_logout_url( home_url() ); ?>">Logout</a></div>
					<?php } else { ?>
						<div class="logout"><a class="logout" href="https://connect.worldforumfoundation.org/login" ?>Login</a></div>
						<?php } ?>
						<div class="search-bar">
